	...
	<div class="container">
		...
		<div class="clearfix"> </div>
			<!---pop-up-box---->    
				...
				<script src="${pageContext.request.contextPath }/static/js/jquery.magnific-popup.js" type="text/javascript"/>
			<!---//pop-up-box---->
				...
				<div class="sap_tabs">	
					 ...
					 <script src="${pageContext.request.contextPath }/static/js/easyResponsiveTabs.js" type="text/javascript"/>
		...
		<div class="login-top">
				...
				<div class="form-info">
					<form action="${pageContext.request.contextPath}/login" method="post">
						<input type="text" class="text" placeholder="用户名" required="" name="userName">
			...
			<div class="create">
				<h4>没有账号?</h4>
				<a class="hvr-sweep-to-right" href="register">创建一个账户</a>
				<div class="clearfix"> </div>
			</div>
	</div>
</div>
